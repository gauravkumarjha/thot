...
return [
    'modules' => [
        ...
        'Chetaru_Edit' => 1,
        'Chetaru_Hotspot' => 1,
        'Chetaru_PriceOutOfStock' => 1,
        'Chetaru_Team' => 1,
        'Chetaru_Thotadmin' => 1,
        'DiMedia_BestsellerSort' => 1,
        'DiMedia_BreadcrumbsSchema' => 1,
        'DiMedia_Collaboration' => 1,
        'DiMedia_CurrencySwitcher' => 1,
        'DiMedia_CustomStatus' => 1,
        'DiMedia_CustomerFieldSelected' => 1,
        'DiMedia_KeepPriceFilter' => 1,
        'DiMedia_Llms' => 1,
        'DiMedia_NotifyForm' => 0,
        'DiMedia_OgTag' => 1,
        'DiMedia_OrderStatusDropdown' => 1,
        'DiMedia_SearchPreprocess' => 1,
        'DiMedia_SendEmail' => 1,
        'DiMedia_SendProductToCrm' => 1,
        'DiMedia_ShiftItems' => 1,
        'DiMedia_ShippingCountryAlert' => 1,
        'DiMedia_ShippingDayUnicomerce' => 1,
        'DiMedia_Utility' => 1,
        'DiMedia_WebpImage' => 1,
        'Ebizmarts_MailChimp' => 1,
        'Etm_Tracking' => 1,
        'FME_Quickrfq' => 1,
        'Faonni_ShippingTweaks' => 1,
        'Google_Translator' => 0,
        ...
        'PayUIndia_Payu' => 1,
        'Plumrocket_ProductFilterFixMagento245' => 1,
        'Razorpay_Magento' => 1,
        'Rossmc_Partytown' => 1,
        'Temando_ShippingRemover' => 1,
        'V4U_BrochureForm' => 0,
        'V4U_CmsWatcher' => 1,
        'V4U_ComingSoonNotify' => 1,
        'V4U_GST' => 1,
        'V4U_Singlepagecheckout' => 1,
        'Ves_All' => 1,
        'Lof_ShopByBrand' => 0,
        'Ves_Megamenu' => 1,
        'Ves_Setup' => 1,
        'Webkul_PaymentShippingRestriction' => 0,
        'Webkul_PhonePe' => 1,
        'Wyomind_Framework' => 1,
        'Wyomind_ElasticsearchBrowser' => 0,
