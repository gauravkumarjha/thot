...
{
    public const URL_PATH_EDIT = 'giftcertificate/gcimages/addtemplate'; // constant variable URL_PATH_EDIT
    public const URL_PATH_DELETE = 'giftcertificate/gcimages/delete'; // constant variable URL_PATH_DELETE
