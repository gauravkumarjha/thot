...
{
    public const URL_PATH_EDIT = 'giftcertificate/index/addcodeset'; // constant variable URL_PATH_EDIT
    public const URL_PATH_DELETE = 'giftcertificate/index/delete'; // constant variable URL_PATH_DELETE
