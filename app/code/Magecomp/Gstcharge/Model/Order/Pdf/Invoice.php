...
class Invoice extends \Magento\Sales\Model\Order\Pdf\Invoice
{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        $codeContents="SupGSTIN:".$helperData->getGstNumber($helperData ->getStoreid())." No:".$invoice_id." Date:".$order->getCreatedAt()." Value:".$order->getGrandTotal()." Items:".$itemcount." Hsn:".$hsnarray;
        ...
        $billingAddress[] = "State Code :" . $helperData->getStateCodeLable($order->getBillingAddress());
        ...
        if (!$order->getIsVirtual()) {
            ...
            $shippingAddress[] = "State Code :" . $helperData->getStateCodeLable($order->getShippingAddress());
