 ...
 */
namespace Webkul\PhonePe\Block\Adminhtml;
...
class Logo extends \Magento\Backend\Block\Template
{
    ...
    public const MODULE_NAME = 'Webkul_PhonePe';

    public const EXPIRE_CONFIG_PATH = 'phonepe/webkul/logo_expire_time';

    public const LOGO_CONFIG_PATH = 'phonepe/webkul/logo';
