    ...
    $.widget('mageplaza.layer', $.mage.accordion, {
        ...
        initObserve: function () {
                ...
                el.bind('click', function (e) {
                    ...
                    setTimeout(function () {
                        if (typeof SgyIAS !== 'undefined' && typeof SgyIAS.init === 'function') {
                            console.log('Reinitializing IAS after slider update checkbox');
                            SgyIAS.init();
                            console.log('SgyIAS:', SgyIAS);
                            console.log('typeof SgyIAS.init:', typeof SgyIAS.init);
                            if (window.ias) {
                                var newNextUrl = $('.next').attr('href'); // adjust selector as needed
                                if (newNextUrl) {
                                    window.ias.nextUrl = newNextUrl;
                                    console.log("nextUrl set manually:", newNextUrl);
                                } else {
                                    console.warn("No .next link found to set nextUrl.");
                                }
                            }
                            ...
                            console.error('SgyIAS or SgyIAS.init not found');
                        }
                    }, 500);
                });
            });
            ...
            optionElements.each(function (index) {
                ...
                el.bind('click', function (e) {
                    ...
                    setTimeout(function () {
                        if (typeof SgyIAS !== 'undefined' && typeof SgyIAS.init === 'function') {
                            console.log('Reinitializing IAS after slider update filter-options a');
                            SgyIAS.init();
                            console.log('SgyIAS:', SgyIAS);
                            console.log('typeof SgyIAS.init:', typeof SgyIAS.init);
                            if (window.ias) {
        ...
        initSlider: function () {
            ...
            for (var code in slider) {
                if (slider.hasOwnProperty(code)) {
                    ...
                    //     }
                    console.log(JSON.parse(sliderConfig.priceFormat));
                    setTimeout(function () {
                    if (sliderElement.length) {
                        sliderElement.slider({
                            ...
                            slide: function (event, ui) {
                                ...
                                console.log("ui1:" + ui.values[0])
                                console.log("ui2:" + ui.values[1])
                                console.log("priceFormat:" + priceFormat)
                            },
                            change: function (event, ui) {
                                console.log("ajaxUrl:" + sliderConfig.ajaxUrl)
                                console.log("ui1:" + ui.values[0])
                                console.log("ui2:" + ui.values[1])
                                self.ajaxSubmit(self.getSliderUrl(sliderConfig.ajaxUrl, ui.values[0], ui.values[1]));
                                setTimeout(function () {
                                    if (typeof SgyIAS !== 'undefined' && typeof SgyIAS.init === 'function') {
                                        console.log('Reinitializing IAS after slider update sliderElement');
                                        SgyIAS.init();
                                        console.log('SgyIAS:', SgyIAS);
                                        console.log('typeof SgyIAS.init:', typeof SgyIAS.init);
                                        if (window.ias) {
        ...
        displaySliderText: function (code, from, to, format) {
            ...
            if (textElement.length) {
                console.log("GauravJha-15-05-2025");
