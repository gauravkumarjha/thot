...
class LayoutProcessor
{
    ...
    public function afterProcess(
        ...
        if($status == 1){
            $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']['shippingAddress']['children']['shipping-address-fieldset']['children']['company_name'] = [
                ...
                'children' => [
                    'company_name' => [
                        ...
                        'config' => [
                            'customScope' => 'company_name',
                            'template' => 'ui/form/field',
                            'elementTmpl' => 'ui/form/element/input',
                            'options' => [],
                            'id' => 'company_name'
                        ],
                        'dataScope' => 'company_name.company_name',
                        'label' => 'Company Name :',
