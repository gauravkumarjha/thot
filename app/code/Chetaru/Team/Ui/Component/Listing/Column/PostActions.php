...
namespace Chetaru\Team\Ui\Component\Listing\Column;
...
{
    private const URL_PATH_EDIT = 'chetaru_team/post/edit';
    private const URL_PATH_DELETE = 'chetaru_team/post/delete';
