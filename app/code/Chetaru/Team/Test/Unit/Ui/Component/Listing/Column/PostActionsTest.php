...
namespace Chetaru\Team\Test\Unit\Ui\Component\Listing\Column;

use Chetaru\Team\Ui\Component\Listing\Column\PostActions;
...
class PostActionsTest extends TestCase
{
    ...
    public function testPrepareDataSourceLinks(): void
    {
        ...
        $this->urlBuilder
            ->method('getUrl')
            ->withConsecutive(
                [$this->equalTo('chetaru_team/post/edit'), $this->equalTo(['post_id' => 1])],
                [$this->equalTo('chetaru_team/post/delete'), $this->equalTo(['post_id' => 1])],
                [$this->equalTo('chetaru_team/post/edit'), $this->equalTo(['post_id' => 2])],
                [$this->equalTo('chetaru_team/post/delete'), $this->equalTo(['post_id' => 2])],
            )
            ->willReturnOnConsecutiveCalls(
                'chetaru_team/post/edit/post_id/1',
                'chetaru_team/post/delete/post_id/1',
                'chetaru_team/post/edit/post_id/2',
                'chetaru_team/post/delete/post_id/2',
            );
