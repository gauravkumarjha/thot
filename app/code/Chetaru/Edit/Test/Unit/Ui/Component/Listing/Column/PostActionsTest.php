...
namespace Chetaru\Edit\Test\Unit\Ui\Component\Listing\Column;

use Chetaru\Edit\Ui\Component\Listing\Column\PostActions;
...
class PostActionsTest extends TestCase
{
    ...
    public function testPrepareDataSourceLinks(): void
    {
        ...
        $this->urlBuilder
            ->method('getUrl')
            ->withConsecutive(
                [$this->equalTo('chetaru_edit/post/edit'), $this->equalTo(['post_id' => 1])],
                [$this->equalTo('chetaru_edit/post/delete'), $this->equalTo(['post_id' => 1])],
                [$this->equalTo('chetaru_edit/post/edit'), $this->equalTo(['post_id' => 2])],
                [$this->equalTo('chetaru_edit/post/delete'), $this->equalTo(['post_id' => 2])],
            )
            ->willReturnOnConsecutiveCalls(
                'chetaru_edit/post/edit/post_id/1',
                'chetaru_edit/post/delete/post_id/1',
                'chetaru_edit/post/edit/post_id/2',
                'chetaru_edit/post/delete/post_id/2',
            );
