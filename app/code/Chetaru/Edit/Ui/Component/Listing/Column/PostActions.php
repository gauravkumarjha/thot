...
namespace Chetaru\Edit\Ui\Component\Listing\Column;
...
{
    private const URL_PATH_EDIT = 'chetaru_edit/post/edit';
    private const URL_PATH_DELETE = 'chetaru_edit/post/delete';
