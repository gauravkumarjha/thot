...
namespace Chetaru\Article\Ui\Component\Listing\Column;
...
{
    private const URL_PATH_EDIT = 'chetaru_article/post/edit';
    private const URL_PATH_DELETE = 'chetaru_article/post/delete';
