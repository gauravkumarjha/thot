...
namespace Chetaru\Article\Test\Unit\Ui\Component\Listing\Column;

use Chetaru\Article\Ui\Component\Listing\Column\PostActions;
...
class PostActionsTest extends TestCase
{
    ...
    public function testPrepareDataSourceLinks(): void
    {
        ...
        $this->urlBuilder
            ->method('getUrl')
            ->withConsecutive(
                [$this->equalTo('chetaru_article/post/edit'), $this->equalTo(['post_id' => 1])],
                [$this->equalTo('chetaru_article/post/delete'), $this->equalTo(['post_id' => 1])],
                [$this->equalTo('chetaru_article/post/edit'), $this->equalTo(['post_id' => 2])],
                [$this->equalTo('chetaru_article/post/delete'), $this->equalTo(['post_id' => 2])],
            )
            ->willReturnOnConsecutiveCalls(
                'chetaru_article/post/edit/post_id/1',
                'chetaru_article/post/delete/post_id/1',
                'chetaru_article/post/edit/post_id/2',
                'chetaru_article/post/delete/post_id/2',
            );
