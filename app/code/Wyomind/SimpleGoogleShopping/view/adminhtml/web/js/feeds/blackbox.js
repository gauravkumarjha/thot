        ...
        loadLibrarySamples: function (elt) {
            ...
            this.currentAjaxRequest = $.ajax({
                ...
                success: function (data) {
                    ...
                    let html = "<table class='inner-attribute'>";
                    if (data.length > 0) {
...
//            this.setPositionAndSize();
        ...
        setPositionAndSize: function () {
            let top = this.getCookie("blackbox.top");
            let left = this.getCookie("blackbox.left");
            let width = this.getCookie("blackbox.width");
            let height = this.getCookie("blackbox.height");
            if (top === null) {
                top = 380;
            }
            if (left === null) {
