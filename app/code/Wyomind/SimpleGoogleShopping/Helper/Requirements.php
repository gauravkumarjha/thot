    ...
    public function getRequirements()
    {
        return [
            ...
            [
                ...
                'type' => 'Text',
                'depends' => [
                    'identifier_exists' => ['neq' => 'FALSE'],
                    'google_product_category' => ['like' => 'Apparel & Accessories']
                ]
            ],
            [
                'label' => 'brand',
            ...
            [
                ...
                'occurrence' => 1,
                'type' => 'RegExp',
                'regexp' => "Shopping|Shopping Actions|Display Ads",
                'say' => 'Shopping, ShoppingActions, DisplayAds'
            ],
            [
                'label' => 'included_destination',
                'tag' => 'g_included_destination',
                'required' => false,
                'occurrence' => 1,
                'type' => 'RegExp',
                'regexp' => "Shopping|Shopping Actions|Display Ads",
