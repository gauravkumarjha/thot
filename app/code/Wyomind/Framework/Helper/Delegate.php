 ...
 */
namespace Wyomind\Framework\Helper;  class Delegate extends \Wyomind\Framework\Helper\License {public $x6e2b8=null;public $x39619=null;public $xb4c49=null; const VERSION = "\67\x2e\62\x2e\64"; public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\App\Helper\Context $context) { parent::__construct($objectManager, $context); $this->constructor($this, func_get_args(), __CLASS__); } protected function getDelegation() { ${$this->x39619->x6d->{$this->x6e2b8->x6d->{$this->x39619->x6d->{$this->x6e2b8->x6d->x95}}}} = "\\"; return [ ]; } }