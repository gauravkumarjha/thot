...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        $meta_title = $brand->getPageTitle();
        if( $meta_title != null ) {
            $page_title2 =  $meta_title; 
        } else {
        ...
        if ($page_title2) {
            $this->pageConfig->setMetaTitle($page_title2);
        }
        if($page_title){
           
            $this->pageConfig->getTitle()->set($page_title2);   
        }
    ...
    public function getPageHeading()
    {
        $brand = $this->getCurrentBrand();
        $page_title = $brand->getName();
        // Logic to determine the page heading
        return $page_title;
    }
}